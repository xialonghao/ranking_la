<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"F:\phpStudys\PHPTutorial\WWW\ranking\public/../application/admin\view\complaint\edit.html";i:1552472764;s:79:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\layout\default.html";i:1552038989;s:76:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\meta.html";i:1552038989;s:78:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\script.html";i:1552038989;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-phone" class="form-control" name="row[phone]" type="number" value="<?php echo $row['phone']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-num" class="form-control" name="row[num]" type="text" value="<?php echo $row['num']; ?>">
        </div>
    </div>
