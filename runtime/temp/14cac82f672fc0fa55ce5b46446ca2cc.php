<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"F:\phpStudys\PHPTutorial\WWW\ranking\public/../application/admin\view\keyword\edit.html";i:1551866736;s:79:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\layout\default.html";i:1551866736;s:76:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\meta.html";i:1551866736;s:78:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\script.html";i:1551866736;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Project_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-project_num" class="form-control" name="row[project_num]" type="text" value="<?php echo $row['project_num']; ?>">
        </div>
    </div>
    <div class="form-group">
