<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"F:\phpStudys\PHPTutorial\WWW\ranking\public/../application/admin\view\general\profile\index.html";i:1552038989;s:79:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\layout\default.html";i:1552038989;s:76:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\meta.html";i:1552038989;s:78:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\script.html";i:1552038989;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="email" class="control-label"><?php echo __('Mobile'); ?>:</label>
                            <input type="text" class="form-control" id="mobile" name="row[mobile]" value="<?php echo $admin['mobile']; ?>" data-rule="mobile" placeholder="<?php echo __('Leave mobile blank if dont want to change'); ?>" />
                        </div>
                        <div class="form-group">
