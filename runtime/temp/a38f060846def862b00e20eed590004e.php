<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"F:\phpStudys\PHPTutorial\WWW\ranking\public/../application/admin\view\sitemail\edit.html";i:1552038989;s:79:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\layout\default.html";i:1552038989;s:76:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\meta.html";i:1552038989;s:78:"F:\phpStudys\PHPTutorial\WWW\ranking\application\admin\view\common\script.html";i:1552038989;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-type_id" data-rule="required" data-source="sitecategory/index" data-params='{"custom[type]":"0"}'class="form-control selectpage" name="row[type_id]" type="text" value="<?php echo $row['type_id']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sort" class="form-control" name="row[sort]" type="text" value="<?php echo $row['sort']; ?>">
        </div>
    </div>
    <div class="form-group">
