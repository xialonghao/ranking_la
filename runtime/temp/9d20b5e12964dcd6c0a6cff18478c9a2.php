<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"/www/wwwroot/pml_zhihuo_com_cn/pml/public/../application/admin/view/worder/worderrecord.html";i:1556510581;s:77:"/www/wwwroot/pml_zhihuo_com_cn/pml/application/admin/view/layout/default.html";i:1552038988;s:74:"/www/wwwroot/pml_zhihuo_com_cn/pml/application/admin/view/common/meta.html";i:1552038988;s:76:"/www/wwwroot/pml_zhihuo_com_cn/pml/application/admin/view/common/script.html";i:1552038988;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="caiwu_diary layui-col-md12 zh_bg_white layui-form">
                    ...
                    <div class="reply_navmess">
                        ...
                        <ul class="clear layui-row">
                            ...
                            <li class="layui-col-md3">状态：处理中<?php echo $list_title['status']; ?></li>
                    ...
                    <div class="reply_form">
                            ...
                            <p>答复</p>
                            <textarea name="remarks" id="conts" placeholder="管理员回复信息"></textarea>
                        <button id="submit">提交答复</button>
                    </div>
                </div>
            </div>
